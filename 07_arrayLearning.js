...
console.log(`----------------------------------------------`);
console.log(`Total Numbres of elements available in the array.........`);
let totalElements=arrayOfNumbers.length;
console.log(`Total Numbers of elements in the array is : ${totalElements}`);
